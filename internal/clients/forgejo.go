...
import (
	...
	clusterv1beta1 "github.com/crossplane-contrib/provider-upjet-forgejo/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/crossplane-contrib/provider-upjet-forgejo/apis/namespaced/v1beta1"
)
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal forgejo credentials as JSON"
)
