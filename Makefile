...
PROJECT_NAME ?= provider-forgejo
PROJECT_REPO ?= github.com/crossplane-contrib/provider-upjet-forgejo
...
export TERRAFORM_PROVIDER_SOURCE ?= svalabs/forgejo
export TERRAFORM_PROVIDER_REPO ?= https://github.com/svalabs/terraform-provider-forgejo
export TERRAFORM_PROVIDER_VERSION ?= 1.6.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-forgejo
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-forgejo_v1.6.0
...
$(TERRAFORM_PROVIDER_SCHEMA): $(TERRAFORM)
	...
	@python3 hack/patch-schema-id-string.py
