...
func (tr *Collaborator) GetObservation() (map[string]any, error) {
...
func (tr *Collaborator) SetObservation(obs map[string]any) error {
...
func (tr *Collaborator) GetParameters() (map[string]any, error) {
...
func (tr *Collaborator) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Collaborator
func (tr *Collaborator) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Collaborator
func (tr *Collaborator) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
